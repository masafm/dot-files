...
(custom-set-variables
 ...
 '(package-selected-packages
   '(terraform-mode yaml-mode jpop tramp org-sidebar rg ripgrep fzf dired-toggle protobuf-mode ibuffer-project elscreen neotree moody spaceline go-mode json-mode ggtags)))
(custom-set-faces
