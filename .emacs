...
(global-set-key "∑" "\M-w")
(global-set-key "´" "\M-e")
(global-set-key "®" 'gtags-find-rtag)
(global-set-key "†" "\M-t")
(global-set-key "¥" "\M-y")
(global-set-key "ˆ" "\M-i")
(global-set-key "ø" "\M-o")
(global-set-key "π" 'gtags-find-pattern)
(global-set-key "“" "\M-[")
(global-set-key "‘" "\M-]")
(global-set-key "å" "\M-a")
(global-set-key "ß" 'gtags-find-symbol)
(global-set-key "∂" "\M-d")
(global-set-key "ƒ" 'gtags-find-file)
(global-set-key "©" "\M-g")
(global-set-key "˙" "\M-h")
(global-set-key "∆" "\M-j")
(global-set-key "˚" "\M-k")
...
(global-set-key "≤" 'gtags-pop-stack)
(global-set-key "≥" 'gtags-find-tag)
(global-set-key "÷" "\M-/")
(global-set-key "¯" "\M-<")
(global-set-key "˘" "\M->")
