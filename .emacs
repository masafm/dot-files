...
(custom-set-variables
 ...
 '(package-selected-packages
   '(groovy-mode gradle-mode dockerfile-mode php-mode python-mode markdown-mode typescript-mode terraform-mode yaml-mode jpop tramp org-sidebar rg ripgrep fzf dired-toggle protobuf-mode ibuffer-project elscreen neotree moody spaceline go-mode json-mode ggtags)))
(custom-set-faces
